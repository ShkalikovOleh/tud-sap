...
\begin{enumerate}
    \item Twins can be monozygotic (M) or dizygotic (D). Monozygotic
          ...
          \begin{enumerate}
              ...
              \]
              Notice, that $P(D) = 1 - P(M)$, so
              \[
              P(BB) = \frac{1}{2}P(M) + \frac{1}{4} (1 - P(M)) = \frac{1}{4} + \frac{1}{4} P(M)
              \]
              Unfortunately, probabilities of dizygotic and monozygotic twins
              haven't been provided so suppose they are equal, then:
              \[
              P(BB) = \frac{1}{4} + \frac{1}{4} \cdot \frac{1}{2} = \frac{3}{8}
              \]
              }
              ...
              \begin{center}
                  \begin{tikzpicture}
                      \begin{axis}[xlabel={$s$},
                          ...
                          \addplot[ycomb, color=blue, mark options={black}, mark=*] coordinates
                              {(2,1)(3,2)(4,3)(5,4)(6,5)
